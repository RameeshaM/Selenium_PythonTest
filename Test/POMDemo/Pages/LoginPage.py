...
class LoginPage():
    ...
    def __init__(self, driver):
        ...
        self.username_texttbox_id = Locators.username_texttbox_id
        self.password_textbox_id = "txtPassword"
        self.login_button_id = "btnLogin"

    def enter_username(self, username):
        self.driver.find_element_by_id(self.username_texttbox_id).clear()
        self.driver.find_element_by_id(self.username_texttbox_id).send_keys(username)
